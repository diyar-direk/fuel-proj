...
function RawAutocomplete({
  ...
  const handleInputChange = useCallback(
    ...
    [openDrop, handleChange, handleOpenDrop, handleValue, handleValueSearch]
  );
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="flex justify-between items-center h-full pr-1">
        <input
          className="pl-1 w-full bg-transparent border-none focus:border-none outline-none"
          type="text"
          ref={inputRef}
