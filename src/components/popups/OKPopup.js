...
/*
  ...
  <OkPopup
    ...
    title={"لا يمكنك القيام بهذا الإجراء"}
  />
*/
export default function OKPopup({ isOpen, onClose, title }) {
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-2">
          ...
          >
            <DialogPanel className="w-full max-w-sm bg-white rounded-lg p-6 shadow-lg font-[Calibri]">
